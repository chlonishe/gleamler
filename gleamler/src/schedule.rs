...
use crate::sys::{
    ERL_NIF_SELECT_ERROR_CANCELLED, ERL_NIF_SELECT_FAILED, ERL_NIF_SELECT_NOTSUP,
    ERL_NIF_SELECT_READ, ERL_NIF_SELECT_READ_CANCELLED, ERL_NIF_SELECT_STOP, ERL_NIF_SELECT_WRITE,
    ERL_NIF_SELECT_WRITE_CANCELLED, ErlNifSelectFlags,
};
