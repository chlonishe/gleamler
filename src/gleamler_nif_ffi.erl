...
make_user(_Arg0, _Arg1) -> exit(nif_library_not_loaded).
user_get_name(_Arg0) -> exit(nif_library_not_loaded).
is_user_banned(_Arg0) -> exit(nif_library_not_loaded).
counter_new(_Arg0) -> exit(nif_library_not_loaded).
counter_read(_Arg0) -> exit(nif_library_not_loaded).
...
net_ip_roundtrip(_Arg0) -> exit(nif_library_not_loaded).
net_socket_roundtrip(_Arg0) -> exit(nif_library_not_loaded).
net_socket_v4_roundtrip(_Arg0) -> exit(nif_library_not_loaded).
net_socket_v6_roundtrip(_Arg0) -> exit(nif_library_not_loaded).
collections_hashset_roundtrip(_Arg0) -> exit(nif_library_not_loaded).
collections_btreeset_roundtrip(_Arg0) -> exit(nif_library_not_loaded).
collections_vecdeque_roundtrip(_Arg0) -> exit(nif_library_not_loaded).
collections_linkedlist_roundtrip(_Arg0) -> exit(nif_library_not_loaded).
collections_btreemap_roundtrip(_Arg0) -> exit(nif_library_not_loaded).
...
stream_range(_Arg0, _Arg1) -> exit(nif_library_not_loaded).
yielder_next(_Arg0) -> exit(nif_library_not_loaded).
make_server_config(_Arg0, _Arg1) -> exit(nif_library_not_loaded).
server_config_get_port(_Arg0) -> exit(nif_library_not_loaded).
